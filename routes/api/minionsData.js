...
exports.minions = [
    { //0
        ...
        upgrade:{
            materials: [
                ["Free at Revenant Tier 5"],
                //["Crystalized Heart","Revenant Flesh"],
                ["Revenant Flesh","Rotten Flesh"],
                ["Revenant Flesh","Rotten Flesh"],
                ["Revenant Flesh","Rotten Flesh"],
                ["Revenant Viscera","Rotten Flesh"],
                ["Revenant Viscera","Enchanted Rotten Flesh"],
                ["Revenant Viscera","Enchanted Rotten Flesh"],
                ["Revenant Viscera","Enchanted Rotten Flesh"],
                ["Revenant Viscera","Enchanted Rotten Flesh"],
                ["Revenant Viscera","Enchanted Rotten Flesh"],
        ...
        upgrade:{
            materials: [
                ["Free at Tarantula Tier 5"],
                //["Fermentaed Spider Eye","Tarantula Web"],
                ["Tarantula Web","String"],
                ["Tarantula Web","String"],
                ["Tarantula Web","String"],
                ["Tarantula Silk","String"],
                ["Tarantula Silk","Enchanted String"],
                ["Tarantula Silk","Enchanted String"],
                ["Tarantula Silk","Enchanted String"],
                ["Tarantula Silk","Enchanted String"],
                ["Tarantula Silk","Enchanted String"],
        ...
        upgrade:{
            materials: [
                ["Null Sphere","Ender Pearl"],
                ["Null Sphere","Obsidian"],
                ["Null Sphere","Ender Pearl"],
                ["Null Sphere","Obsidian"],
                ["Null Ovoid","Enchanted Ender Pearl"],
                ["Null Ovoid","Enchanted Obsidian"],
                ["Null Ovoid","Enchanted Ender Pearl"],
                ["Null Ovoid","Enchanted Obsidian"],
                ["Null Ovoid","Enchanted Eye of Ender"],
                ["Null Ovoid","Enchanted Obsidian"],
                ["Null Ovoid","Enchanted Eye of Ender"],
            ],
            quantities: [
